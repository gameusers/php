...
// \Debug::dump($group, $content, $content);
      ...
      <div class="<?php if ($group !== 'feed') echo 'element_hidden';?>" id="menu_feed">
        ...
        <div class="margin_bottom_30">
          ...
          <div class="normal border_color_1" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="all">
            ...
            <div class="selected_icon<?php if ($group === 'feed' and $content !== 'all') echo ' element_hidden';?>">
              <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                <div class="rect3"></div>
          ...
          <div class="normal border_color_2" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="bbs">
            ...
            <div class="selected_icon<?php if ($group !== 'feed' or $content !== 'bbs') echo ' element_hidden';?>">
              <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                <div class="rect3"></div>
          ...
          <div class="normal border_color_3" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="recruitment">
            ...
            <div class="selected_icon<?php if ($group !== 'feed' or $content !== 'recruitment') echo ' element_hidden';?>">
              <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                <div class="rect3"></div>
          ...
          <div class="normal border_color_4" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="community">
            ...
            <div class="selected_icon<?php if ($group !== 'feed' or $content !== 'community') echo ' element_hidden';?>">
              <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                <div class="rect3"></div>
        ...
        <div class="margin_bottom_40">
          <div class="normal border_color_5" id="menu_card" data-look-ahead="true" data-page="1" data-group="feed" data-content="register_game">
            ...
            <div class="selected_icon<?php if ($group !== 'feed' or $content !== 'register_game') echo ' element_hidden';?>">
              <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                <div class="rect3"></div>
  ...
  <nav id="slideMenu" class="slideMenu">
    ...
    <div class="<?php if ($group !== 'feed') echo 'element_hidden';?>" id="menu_feed">
      ...
      <div class="box" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="all">
        <div class="left"><i class="material-icons">cloud_queue</i></div>
        <div class="right"><span class="<?php if (($group === 'feed' and $content === 'all') or $group !== 'feed') echo 'selected';?>">すべて</span></div>
      </div>

      <div class="box" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="bbs">
        <div class="left"><i class="material-icons">forum</i></div>
        <div class="right"><span class="<?php if ($group === 'feed' and $content === 'bbs') echo 'selected';?>">交流掲示板</span></div>
      </div>

      <div class="box" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="recruitment">
        <div class="left"><i class="material-icons">priority_high</i></div>
        <div class="right"><span class="<?php if ($group === 'feed' and $content === 'recruitment') echo 'selected';?>">募集掲示板</span></div>
      </div>

      <div class="box" id="menu_card" data-page="1" data-group="feed" data-content="index" data-feed="community">
        <div class="left"><i class="material-icons">group</i></div>
        <div class="right"><span class="<?php if ($group === 'feed' and $content === 'community') echo 'selected';?>">コミュニティ</span></div>
      </div>
      ...
      <div class="box" style="margin-top: 30px;" id="menu_card" data-look-ahead="true" data-page="1" data-group="feed" data-content="register_game">
        <div class="left"><i class="material-icons">games</i></div>
        <div class="right"><span class="<?php if ($group === 'feed' and $content === 'register_game') echo 'selected';?>">ゲーム登録</span></div>
      </div>
...
<?php if ( ! AGENT_TYPE): // コンテンツ PC版 ?>
  ...
  <article class="content<?php if ($group !== 'keyword' or $content !== 'index') echo ' element_hidden';?>" style="margin: 0 0 25px 0" id="content_feed_index">
...
<?=$code_social?>
  ...
  <div class="content<?php if ($group !== 'feed' or $content !== 'register_game') echo ' element_hidden';?>" style="margin: 0 20px 10px 5px" id="content_feed_register_game">
<?=$code_register_game?>
  </div>
...
<?php else: // コンテンツ スマホ・タブレット版  ?>
  ...
  <div class="wrapper_s">
    ...
    <article class="content_s<?php if ($group !== 'feed' or $content === 'register_game') echo ' element_hidden';?>" style="margin: 0 0 15px 0" id="content_feed_index">
  ...
  <?=$code_feed?>
    ...
    <div class="content_s<?php if ($group !== 'feed' or $content !== 'register_game') echo ' element_hidden';?>" style="margin: 0 0 10px 5px" id="content_feed_register_game">
<?=$code_register_game?>
    </div>
