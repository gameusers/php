...
<?php if ($language == 'ja'): ?>
        ...
        <div style="margin: 40px 0 0 0">
          ※ 2017年8月31日で、Yahooアカウントでのログインができなくなりました。Yahooアカウントを利用していた方は、Game Usersで利用していたプロフィール名、またはプロフィールページのURLなど、ユーザーが判別できるような情報を、ヘルプ &gt; お問い合わせフォームより送ってください（返信用メールアドレスが必要です）。IDとパスワードを利用したログインができるように設定させてもらいます。
        </div>
