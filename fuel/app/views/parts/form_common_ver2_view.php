 ...
 * string / $send_button_label / 送信ボタンの表示名　デフォルトは「送信する」
...
$code_send_button_label = ($send_button_label) ?? '送信する';
...
<div class="clearfix form_common_box<?=$s?>" id="form_box">
...
if (isset($profile_arr))
{
	...
	echo '        <div id="personal_box" style="margin:0 0 10px 0">' . "\n";
	...
	if ($anonymity)
	{
		echo '        <div id="personal_box_anonymity" style="margin:0 0 10px 0">' . "\n";
		$view_personal_box = View::forge('parts/personal_box_ver3_view');
		$view_personal_box->set_safe('datetime_now', $datetime_now);
...
<?php endif; ?>
        ...
        <div class="form_common_submit_left"><button type="submit" class="btn btn-success ladda-button" data-style="expand-right" id="submit" onclick="<?=$func_name?>(<?=$func_argument?>)"><span class="ladda-label"><?=$code_send_button_label?></span></button></div>
