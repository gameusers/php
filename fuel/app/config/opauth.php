...
return array(
     ...
     */
    'path' => '/gameusers/public/login/auth/',
     ...
     */
      ...
      */
    'callback_url'  => '/gameusers/public/login/callback/',
     ...
     */
    'security_salt' => '4yrepNAExtTeNkBRO95vvMZbaPQGmM80',
    ...
    'Strategy' => array(
        ...
        'Google' => array(
			'client_id' => '',
			'client_secret' => '',
			//'redirect_uri' => Uri::base(false) . 'login/callback',
			'scope' => 'openid',
			'openid_realm' => 'https://localhost',
		),
        'OpenID' => array(),
    ),
);
